Pod::Spec.new do |spec|
  ...
  spec.source             = { :git => "https://github.com/Ververtom/ALCameraViewController.git", :tag => spec.version.to_s }
  ...
  spec.homepage           = "https://github.com/Ververtom/ALCameraViewController.git"
